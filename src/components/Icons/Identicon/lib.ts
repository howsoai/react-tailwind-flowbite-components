// Taken from https://github.com/laurentpayot/minidenticons/blob/main/minidenticons.js
// This is mostly because the module is ESM only and life sucks mixing CJS.
